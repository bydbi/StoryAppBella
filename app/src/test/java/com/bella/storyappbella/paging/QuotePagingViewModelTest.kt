...
import com.bella.storyappbella.DataDummy
import com.bella.storyappbella.MainDispatcherRule
import com.bella.storyappbella.api.respon.ListStoryItem
import com.bella.storyappbella.getOrAwaitValue
import com.bella.storyappbella.main.MainAdapter
...
class QuotePagingViewModelTest {
    @get:Rule
    ...
    fun `when Get Quote Should Not Null and Return Data`() = runTest {
        val dummyQuote = DataDummy.generateDummyQuoteRespon()
        ...
        val mainViewModel = QuotePagingViewModel(quoteRepository)
